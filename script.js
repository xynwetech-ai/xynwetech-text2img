...
function _dl(){if(!_u){_t("\u26a0\ufe0f Generate an image before downloading");return;}var a=document.createElement("a");a.href=_u;a.download="nothing_text2img_"+Date.now()+".png";document.body.appendChild(a);a.click();document.body.removeChild(a);_t("\u2b07\ufe0f Download started!");}
async function _gen(){
if(_g)return;
...
pv.innerHTML='<div class="image-frame"><img id="resultImg" src="'+_u+'" alt="Generated image"><div class="noise-overlay"></div><button class="btn-eye" data-act="eye" aria-label="View fullscreen"><i class="ri-eye-line"></i></button></div>';
